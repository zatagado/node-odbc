declare namespace odbc {
  ...
  interface Statement {
    ...
    execute<T, O extends QueryOptions>(options: O | null | undefined, callback: (error: NodeOdbcError, result: O extends MultipleResultSetsQueryOptions ? Array<Result<T>> : Result<T>) => undefined): undefined;
    ...
    execute<T, O extends QueryOptions>(options?: O | null): Promise<O extends MultipleResultSetsQueryOptions ? Array<Result<T>> : Result<T>>;
  ...
  interface QueryOptions {
    ...
    /** When true, returns an array of result sets (each has the usual Result shape). Incompatible with cursor/fetchSize. */
  ...
  interface MultipleResultSetsQueryOptions extends QueryOptions {
  ...
  interface Connection {
    ...
    query<T, O extends QueryOptions>(sql: string, options: O, callback: (error: NodeOdbcError, result: O extends CursorQueryOptions ? Cursor : O extends MultipleResultSetsQueryOptions ? Array<Result<T>> : Result<T>) => undefined): undefined;
    query<T, O extends QueryOptions>(sql: string, parameters: Array<number|string>, options: O, callback: (error: NodeOdbcError, result: O extends CursorQueryOptions ? Cursor : O extends MultipleResultSetsQueryOptions ? Array<Result<T>> : Result<T>) => undefined): undefined;
    ...
    query<T, O extends QueryOptions>(sql: string, options: O): O extends CursorQueryOptions ? Promise<Cursor> : O extends MultipleResultSetsQueryOptions ? Promise<Array<Result<T>>> : Promise<Result<T>>;
    query<T, O extends QueryOptions>(sql: string, parameters: Array<number|string>, options: O): O extends CursorQueryOptions ? Promise<Cursor> : O extends MultipleResultSetsQueryOptions ? Promise<Array<Result<T>>> : Promise<Result<T>>;
